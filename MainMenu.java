...
public class MainMenu {
    public static void main(String[] args) {
        ...
        do {
            ...
            System.out.println("\t[4] Stack with Arrays");
            System.out.println("\t[5] Stack with Linked List");
            System.out.println("\t[6] Queue with Arrays");
            System.out.println("\t[7] Queue with Linked List");
            System.out.println("\t[8] Node List Operations");
            System.out.println("\t[9] Convert Infix to Postfix");
